h_template = r'''
// Generated by the UE4ProtobufPlugin.  DO NOT EDIT!
...
public:
    ...
    ${#TODO:过滤不支持的类型}$
    UPROPERTY(${struct_wrapper['uproperty_specifiers']}$${write(pb_helper.get_option_value(pb_field.GetOptions(), 'm_uproperty'))}$)
